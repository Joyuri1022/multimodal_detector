...
def main() -> None:
    ...
    st.markdown(
        ...
        <div class="hero">
            ...
            <p>Uses the scraped-data checkpoint with a cool editorial palette that clearly distinguishes it
    ...
    st.markdown(
        ...
        <div class="input-panel">
            ...
            <p style="margin:0 0 0.8rem 0;">Upload an image and enter the matching headline or caption here. This section stays in the main page for easier use on mobile.</p>
        </div>
        """,
        unsafe_allow_html=True,
    )
