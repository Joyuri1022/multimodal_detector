...
def main() -> None:
    ...
    st.markdown(
        ...
        .input-panel {{
            ...
            box-shadow: 0 12px 35px rgba(23, 96, 135, 0.08);
            margin-bottom: 1rem;
        }}
    ...
    st.markdown(
        ...
        <div class="hero">
            ...
            <p>This demo uses a checkpoint trained on the scraped news dataset.</p>
        </div>
        """,
        unsafe_allow_html=True,
    )
    ...
    st.markdown(
        ...
        <div class="input-panel">
            <h3 style="margin:0 0 0.75rem 0;">Input</h3>
            <p style="margin:0 0 0.8rem 0;">Provide both an image and its related text, then click Run Prediction to see whether the pair is classified as True or Fake.</p>
        </div>
        """,
        unsafe_allow_html=True,
    )
    st.caption("Step 1. Upload one image for analysis.")
    uploaded_file = st.file_uploader("Upload image", type=["jpg", "jpeg", "png", "webp"])
    st.caption("Step 2. Enter the related headline or caption.")
    ...
    if not run_inference:
        ...
        st.info("Run Prediction clicked. Please wait while the model loads and processes your input.")
